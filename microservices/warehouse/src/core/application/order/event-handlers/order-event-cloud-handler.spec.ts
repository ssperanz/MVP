...
import { OrderEventCloudHandler } from './order-event-cloud-handler.js';

describe('OrderEventCloudHandler', () => {
  let publisherMock: OrderEventCloudPublisher;
  let orderEventCloudHandler: OrderEventCloudHandler;
  ...
  beforeEach(() => {
    ...
    orderEventCloudHandler = new OrderEventCloudHandler(publisherMock);
  });
  ...
  it('should call publishOrderCreated with correct parameters', async () => {
    ...
    await orderEventCloudHandler.onOrderCreated(event);
  ...
  it('should call publishOrderStateUpdated with correct parameters', async () => {
    ...
    await orderEventCloudHandler.onOrderStateUpdated(event);
